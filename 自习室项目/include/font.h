...
extern void Font_write(struct lcd *lcd,char *str,int x,int y);
extern void Font_exit(struct lcd *lcd,char *str);
extern void Font_pay(struct lcd *lcd,char *str);
extern void Font_num(struct lcd *lcd,char *str);
extern void Font_limit(struct lcd *lcd,char *str,int x,int y);
extern void Font_zt(struct lcd *lcd,char *str,int x);
extern void Font_log(struct lcd *lcd,char *str);
#endif